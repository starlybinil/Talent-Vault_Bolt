...
export default function Navbar() {
  ...
  return (
    <nav className={`bg-asu-dark/90 backdrop-blur-md shadow-xl border-b border-asu-maroon/30 fixed ${user ? 'top-0' : 'top-[68px] sm:top-[64px] md:top-[48px]'} left-0 right-0 z-50`}>{/* Positioned below announcement banner when logged out, at top when logged in */}
